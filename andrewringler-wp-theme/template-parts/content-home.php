	...
	*/
	...
	<li class="home-post-title">										
		...
		if(!empty($image)):
			...
			// calculate width of image, given a fixed height of 200px
			$width = '200px';
			...
			$img_url = wp_get_attachment_image_src($img_id,'home-200w', true);							
			...
			<div class="homepage-entry-image">
				<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>">
					<img data-rel-w="<?php echo $image['width']; ?>" data-rel-h="<?php echo $image['height']; ?>" src="<?php echo $img_url[0]; ?>" alt="<?php echo $alt_text; ?>" srcset="<?php echo $srcset; ?>" sizes="((max-width: 10000px) and (max-height: 10000px)) <?php echo $width; ?>, <?php echo $width; ?>" />							
				</a>								
			</div>
